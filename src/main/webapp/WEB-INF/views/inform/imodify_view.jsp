...
<table class="w-100">
	<tr>
		<td align="center" colspan="2"><input type="text" name="ititle" value=" ${imodify_view.ititle }" size="40" /> </td>
	</tr>
	<tr>
		<td style="text-align: right;">[등록일]${imodify_view.idate }</td>
	</tr>
	<tr>
	...
	<tr>
		<td><textarea name="icontent" id="icontent" cols="60" rows="10">${imodify_view.icontent }</textarea></td>
	</tr>
	<tr>
		<td colspan="4">
