...
<body>
	<div class="d-flex justify-content-around h-100">
		<a href="/project_UDB" style="color: green; font-size: 30px;">
	...
	<div class="d-flex justify-content-center" id="container">
		<div id="content">
			<form action="join" method="post">
				...
				<div>
					<label>ID 입력<span> ※ </span></label><br /> 
					<input type="text" name="id" id="id" size="35" class="validate required" placeholder="2자리~8자리" /> 
					<br />
					<span id="idEl" style="font-style: italic; color: red;">&nbsp;&nbsp;${idDupl }</span>
				...
				<div>
					<label>비밀번호 입력<span> ※ </span></label><br /> 
					<input type="password" name="pw1" id="pw1" size="35" class="validate required" /> <br> 영문(대,소구별),숫자,특수문자 조합 8~12자
				</div>
				<hr />

				<div>
					<label>비밀번호 확인<span> ※ </span></label><br /> <input type="password" name="pw2" id="pw2" size="35" class="validate required" /> <br />
				</div>
				<hr />

				<div>
					<label>이름<span> ※ </span></label><br /> 
					<input type="text" name="msname" id="msname" size="35" class="validate required" />
					<span id="nnEl" style="font-style: italic; color: red;">&nbsp;&nbsp;${nnDupl }</span>
				</div>
				<hr />

				<div>
					<label>이메일 입력<span> ※ </span></label>
					<br /> 
				...
				<div>
					...
					<br>
					<input type="text" id="msaddr" name="msaddr" placeholder="주소" class="validate required">
					<br> 
					<input type="text" id="msdetailaddress" name="msdetailaddress" placeholder="상세주소">
					<input type="text" id="msextraaddress" name="msextraaddress" placeholder="참고항목"> 
					<br />
