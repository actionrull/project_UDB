            ...
            <div class="row">
               <div class="col-md-4">
                  <div class="single-service">
                     ...
                     <p></p>
                        <br />
                     <a href="<%=application.getContextPath()%>/inform/iList" class="border-btn" style="width: 145px;">더보기</a>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="single-service">
                     ...
                     <p></p>
                     <br />
                     <a href="faq" class="border-btn" style="width: 145px;">더보기</a>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="single-service ">
                     ...
                     <p></p>
                     <br />
                     <a href="<%=application.getContextPath()%>/question/qList" class="border-btn" style="width: 145px;">더보기</a>
                  </div>
               </div>
            </div>
            <div class="row">
               <div class="col-md-4">
                  <div class="single-service ">
                     ...
                     <p></p>
                     <br />
                     <a href="campaign" class="border-btn" style="width: 145px;">더보기</a>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="single-service ">
                     ...
                     <p></p>
                     <br />
                     <a href="policy" class="border-btn" style="width: 145px;">더보기</a>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="single-service">
                     ...
                     <p></p>
                     <br />
                     <a href="report" class="border-btn" style="width: 145px;">더보기</a>
                  </div>
               </div>
            </div>
         </div>
