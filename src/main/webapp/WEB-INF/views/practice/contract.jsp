...
function nochk(){
 ...
 location.href="<%=application.getContextPath()%>/practice/contract";
}
</script>
<link rel="stylesheet"
...
제24조(재판권 및 준거법)
  ...
  ② “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
   ...
   <td align="center" valign="top">
    ...
    <div id="dialog" title="회원 종류 선택" style="display: none;" align="center">
         <a href="<%=application.getContextPath()%>/join-view">개인 회원</a> |
         <a href="<%=application.getContextPath()%>/offerjoin-view">기업 회원</a> 
   </div>   
   </td>
  </tr>
 </table>
