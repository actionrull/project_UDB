...
<body>
<div class="container">
<!-- <h4 style="text-align: left; margin-left: 150px;">후기 작성</h4>
<hr align="center"
...
<form action="fwrite" method="post" enctype="multipart/form-data">
	<table class="w-100" style="margin-left: auto; margin-right: auto;">
		<tr>
			<td>제목</td>
			<td><input type="text" name="ftitle" size="30" /></td>
		</tr>
		...
		<tr>
			<td>내용</td>
			<td><textarea id="fcontent" name="fcontent"  cols="50" rows="5"></textarea> </td>
		</tr>
		<tr>
			<td colspan="2">
