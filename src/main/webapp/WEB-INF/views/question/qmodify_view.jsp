...
<table  style="margin-left: auto; margin-right: auto; 
	...
	<tr>
		...
		<input  style="size: 8;border: 0px; text-align: center;" type="text" name="qtitle"  value=" ${qmodify_view.qtitle }" size="40" /> </td>
	</tr>
	<tr>
		<td colspan="2" style="text-align: right ;">[작성자] ${qmodify_view.qwriter }</td>
	</tr>
	<%-- <tr>
	...
	<tr>
		<td><textarea name="qcontent" id="qcontent" cols="60" rows="10">${qmodify_view.qcontent }</textarea></td>
	</tr>
	<tr>
		<td colspan="4">
...
<br />
<div style="margin-left: auto; margin-right: auto; width: 1150px; height: 400px; 
border: solid 2px gray; border-radius: 1em;" >
<br />
	<textarea style="display: block; " 
 	name="qcontent" id="qcontent" cols="30" rows="4">${qmodify_view.qcontent }</textarea>
</div>
<br /><br />
